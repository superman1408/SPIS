...
import csv
from modules.PipelineCrossingCalculation.ui_design.pipeline_simulation import Ui_MainWindow
from modules.PipelineCrossingCalculation.ui_design.pipeline_calculation import calculate_pipeline_crossing, calculate_bored_diameter_value
import traceback
import os
from modules.PipelineCrossingCalculation.ui_design.report_generator import generate_pipeline_report 
...
# # -----------------------------------
# class PipelineCrossingWindow(QMainWindow):
#     def __init__(self):
#         super().__init__()
